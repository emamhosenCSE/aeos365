    ...
    return (
        <>
            ...
            <PageHeader
                ...
                subtitle="Configure platform-wide integration settings and API keys"
                ...
                >
                    ...
                    <CardBody>
                        <p className="text-default-600">
                            Manage platform-wide integration settings, API keys, OAuth configurations, 
...
Integrations.layout = (page) => <App>{page}</App>;
