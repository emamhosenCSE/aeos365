    ...
    return (
        <>
            ...
            <PageHeader
                ...
                subtitle="Registration funnel, conversion rates, and activation metrics"
                ...
                >
                    ...
                    <CardBody>
                        <p className="text-default-600">
                            Track registration funnel performance, conversion metrics, and tenant activation rates.
                        </p>
                        <p className="mt-4 text-sm text-default-500">
                            Analytics dashboard and reports coming soon.
                        </p>
                    </CardBody>
                </Card>
            </div>
